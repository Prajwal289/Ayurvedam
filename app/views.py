...
def customer(request):
    if request.method == "GET":
        ...
        return render(request, 'app/report_customer.html', { 'data': serializer.data })
...
def product(request):
    if request.method == "GET":
        ...
        return render(request, 'app/report_product.html', { 'data': serializer.data })
    return HttpResponse("success")
...
def orderplaced(request):
    if request.method == "GET":
        ...
        # print("serializer = ", serializer.data)
        # return JsonResponse(serializer.data, safe=False, status=200)
        return render(request, 'app/report_order.html', { 'data': serializer.data })
